...
#
# These are the single source of truth for the build tooling. The folio-fonts
# release workflow (release-fonts.yml, in the folio-fonts repo) and both Python
# scripts (fontconvert_sdcard.py, generate-font-manifest.py) read from here.
#
